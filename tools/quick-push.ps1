...
if (-not (Test-Path "README.md")) {
    ...
    "# mcp-ultra-sdk-custom`n`nMCP-Ultra SDK Custom v9.0.0" | Out-File -FilePath "README.md" -Encoding UTF8
}
...
$commitMsg = "feat: initial commit mcp-ultra-sdk-custom v9.0.0"
