...
| Código compila | ❌ FALHOU | 82.86s | Não compila: # github.com/vertikon/mcp-ultra-sdk-custom/internal/handlers
...
| Testes PASSAM | ✅ PASSOU | 3.88s | ⚠ Sem testes (aceitável para templates) |
| Coverage >= 70% | ⚠️ WARNING | 4.75s | Erro ao calcular coverage |
### 🔒 Segurança
...
| Check | Status | Tempo | Observação |
|-------|--------|-------|------------|
| Formatação (gofmt) | ✅ PASSOU | 0.17s | ✓ Formatação OK |
...
| Check | Status | Tempo | Observação |
|-------|--------|-------|------------|
| NATS subjects documentados | ⚠️ WARNING | 0.01s | NATS não documentado |
### 📚 Docs
...
**Gerado automaticamente em:** 2025-10-05 20:42:00
